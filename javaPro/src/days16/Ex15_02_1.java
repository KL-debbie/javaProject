...
public class Ex15_02_1 {
	...
	public static void main(String[] args) throws InputMismatchException, IOException {
		...
		// [ checked 예외 ]- 어떤식으로든 예외 처리를 해야함 Exception 상속받을시
		// Unhandled exception type IOException
	
		// [ checked 예외 ]- 어떤식으로든 예외 처리를 해야함 Exception 상속받을시
		// [unchecked 예외] - ***선택적 RuntimeException 상속시(알아서 처리하길)***
		int kor = getScore();
	...
	*/
	 ...
	 public static int getScore() throws InputMismatchException, IOException {
